...
<body>
                    ...
                    <nav class="navbar navbar-expand-lg ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto">
                               ...
                               <li class="nav-item">
                                <a class="nav-link" href="client.php">Client</a></li>
                               <li class="#" href="#">
	...
	<div class="footer_section layout_padding contact_section">
		<div class="container">
			<div class="row">
			    <div class="col-sm-3">
		    	...
		    	<div class="row">
		    		<div class="col-md-6">
                       ...
                       <div class="send_bt_main">
                       	<div class="left">
                       		<button class="send_bt" type="submit" name="submit" value="send">SEND</button>
                       	</div>
                         </form>
                       	<div class="right">
		    ...
		    <div class="copyright_section">
		    	<p class="copyright_text">Copyright 2020 aditya chauhan.</p>
		    </div>
		</div>
	</div>
	<!--footer section end -->
